                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $ms['Asal'] }}</td>
                      <td>
                        <a href="{{ route('mahasiswa.show', $ms['NPM']) }}" class="btn btn-info btn-sm">Detail</a>
                        <a href="{{ route('mahasiswa.edit', $ms['NPM']) }}" class="btn btn-warning btn-sm">Edit</a>
                        <form action="{{ route('mahasiswa.destroy', $ms['NPM']) }}" method="POST" style="display:inline;">
                          @csrf @method('DELETE')
