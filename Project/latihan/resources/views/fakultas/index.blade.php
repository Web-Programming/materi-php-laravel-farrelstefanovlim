                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $fk['nama_fk'] }}</td>
                      <td>
                        <a href="{{ route('fakultas.show', $fk['nama_fk']) }}" class="btn btn-info btn-sm">Detail</a>
                        <a href="{{ route('fakultas.edit', $fk['nama_fk']) }}" class="btn btn-warning btn-sm">Edit</a>
                        <form action="{{ route('fakultas.destroy', $fk['NPM']) }}" method="POST" style="display:inline;">
                          @csrf @method('DELETE')
